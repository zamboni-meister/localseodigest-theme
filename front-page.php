...
$btn1_text      = get_post_meta( $post_id, '_lsd_btn1_text',      true ) ?: 'Read the blog';
$btn1_url       = get_post_meta( $post_id, '_lsd_btn1_url',       true ) ?: get_permalink( get_option( 'page_for_posts' ) );
$btn2_text      = get_post_meta( $post_id, '_lsd_btn2_text',      true ) ?: 'Get the digest';
...
<section class="lsd-section lsd-section--white">
	<div class="lsd-section__header">
		...
		<a href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ); ?>" class="lsd-section__link">View all →</a>
	</div>
	...
	<div class="lsd-articles-grid">
		...
		?>
			<p class="lsd-no-posts">No posts published yet. <a href="<?php echo esc_url( admin_url( 'post-new.php' ) ); ?>">Write your first post →</a></p>
		<?php endif; ?>
	</div>
</section>
