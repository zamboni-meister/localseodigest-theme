...
$hero_sub = get_post_meta($id, 'lsd_ab_hero_sub', true) ?: 'Local SEO Digest is a knowledge hub for local search ~ built to cut through the noise and give marketers, agencies, and business owners something actually useful.';
        ...
        <div class="container about-section__inner">
            ...
            <div class="about-cards">
                ...
                <div class="about-card">
                    ...
                    <a href="<?php echo esc_url(home_url('/digest/')); ?>" class="about-card__link">Explore the
                        Digest &rarr;</a>
                </div>
                ...
                <div class="about-card">
                    ...
                    <a href="<?php echo esc_url(home_url('/blog/')); ?>" class="about-card__link">Read the blog
                        &rarr;</a>
                </div>
                ...
                <div class="about-card">
                    ...
                    <a href="<?php echo esc_url(home_url('/newsletter/')); ?>" class="about-card__link">Subscribe
                        &rarr;</a>
                </div>
                ...
                <div class="about-card">
                    ...
                    <a href="<?php echo esc_url(home_url('/resources/')); ?>" class="about-card__link">See resources
                        &rarr;</a>
                </div>
                ...
                <div class="about-card">
                    ...
                    <a href="<?php echo esc_url(home_url('/glossary/')); ?>" class="about-card__link">Browse the
                        glossary &rarr;</a>
                </div>
            ...
            <div class="about-steps">
                ...
                <div class="about-step">
                    ...
                    <div class="about-step__content">
                        ...
                        <p><?php echo wp_kses($step1_body, array('a' => array('href' => array(), 'title' => array()))); ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="about-step">
                    ...
                    <div class="about-step__content">
                        ...
                        <p><?php echo wp_kses($step2_body, array('a' => array('href' => array(), 'title' => array()))); ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="about-step">
                    ...
                    <div class="about-step__content">
                        ...
                        <p><?php echo wp_kses($step3_body, array('a' => array('href' => array(), 'title' => array()))); ?>
                        </p>
                    </div>
                </div>
