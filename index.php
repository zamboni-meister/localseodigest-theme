            ...
            <aside role="complementary">
                ...
                <?php else: ?>
                    ...
                    <div class="widget">
                        ...
                        <p style="font-size: 0.875rem; color: var(--mid-gray); line-height: 1.6; margin-bottom: 14px;">
                            Weekly local SEO insights from Zane Creek — documenting the journey to help you grow your local
                            business.</p>
                        <a href="<?php echo esc_url(home_url('/about/')); ?>"
                            style="font-size: 0.82rem; font-weight: 600; color: var(--yellow-dark);">Learn more &rarr;</a>
                    </div>
                    ...
                    <div class="widget" style="background: var(--ink); color: var(--white);">
                        <h3 class="widget-title" style="color: var(--yellow); border-bottom-color: var(--yellow);">
                            Newsletter</h3>
                        <p
                            style="font-size: 0.875rem; color: rgba(255,255,255,0.6); line-height: 1.6; margin-bottom: 16px;">
                            Get weekly local SEO insights straight to your inbox.</p>
                        <a href="#newsletter" class="btn btn--primary"
                            style="font-size: 0.8rem; padding: 10px 18px; display: inline-flex;">Subscribe free</a>
                    </div>
