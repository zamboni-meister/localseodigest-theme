        ...
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="footer-brand__logo">
                    <img src="https://localseodigest.com/wp-content/uploads/2026/04/Local-SEO-Digest-Logo-1.webp" alt="Local SEO Digest logo" style="height: 28px; width: auto; display: inline-block; vertical-align: middle; margin-right: 2px; margin-left: -10px;">Local
