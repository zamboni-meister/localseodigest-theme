            ...
            <div class="site-header__inner">
                ...
                <?php else: ?>
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="site-logo">
                        <img src="https://localseodigest.com/wp-content/uploads/2026/04/Local-SEO-Digest-Logo-1.webp" alt="Local SEO Digest logo" style="height: 32px; width: auto; display: inline-block; vertical-align: middle; margin-right: 2px; margin-left: -10px;">Local
                ...
                <nav class="main-nav" id="main-nav" role="navigation" aria-label="Primary navigation">
                    ...
                    ?>
                    <a href="<?php echo esc_url(get_page_link(get_page_by_path('newsletter')) ?: '#newsletter'); ?>"
